if surface_exists(horizon_surface) {
		surface_set_target(horizon_surface);
			...
			draw_sprite_ext(spr_env_horizon_fade, 0, 0, 0, global.vw, 1, 0, c_water_horizon, 1);
			draw_sprite_tiled_ext(spr_env_horizon_twinkle, 0, -horizon_twinkle_pos, 0, 1, 1, c_water_horizon, .25*horizon_twinkle_alpha);
			draw_sprite_tiled_ext(spr_env_horizon_twinkle, 1, -horizon_twinkle_pos, 0, 1, 1, c_water_horizon, .25*(1-horizon_twinkle_alpha));
